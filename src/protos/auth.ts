...
export const LoginResult: MessageFns<LoginResult> = {
  ...
  fromJSON(object: any): LoginResult {
    return {
      loginCode: isSet(object.loginCode)
        ? loginCodeFromJSON(object.loginCode)
        : 0,
  ...
  fromPartial<I extends Exact<DeepPartial<LoginResult>, I>>(
    object: I
  ): LoginResult {
    const message = createBaseLoginResult();
...
export const AuthServiceService = {
  login: {
    ...
    responseSerialize: (value: LoginResult) =>
      Buffer.from(LoginResult.encode(value).finish()),
